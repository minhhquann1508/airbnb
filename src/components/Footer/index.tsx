...
export default function Footer():JSX.Element {
  return (
    <footer className="p-6 dark:bg-gray-800 dark:text-gray-100 border bg-gray-200">
      ...
      <div className='hidden md:flex justify-between bg-white border py-2 px-5 fixed left-0 w-full bottom-0'>

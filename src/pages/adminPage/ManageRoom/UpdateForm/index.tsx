...
import { getListAllLocation, updateRoomAction } from "../duck/action";
...
export default function UpdateForm(props:any) {
    ...
    const formik = useFormik({
        ...
        onSubmit:(values:RoomFormat) => {
            dispacth(updateRoomAction(itemData.id,values,closeModal,activePage));
        }
    })
        ...
        <form onSubmit={formik.handleSubmit} className="pt-3">
            <div className="grid grid-cols-2 gap-3">
                <div className="col-span-full">
                    ...
                    <input type="text" disabled={true} name="id" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.id} className="cursor-not-allowed p-2 border w-full rounded-md" />
                </div>
                <div className="col-span-full">

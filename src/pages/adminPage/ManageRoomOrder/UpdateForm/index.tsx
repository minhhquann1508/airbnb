...
export default function UpdateForm(props:any) {
    ...
    return (
        <form onSubmit={formik.handleSubmit} className="pt-5">
                ...
                <div className="mb-6">
                    <label className="block mb-2 text-sm font-medium text-gray-900">Mã phòng</label>
                    <input type="text" disabled={true} name="maPhong" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.maPhong} className="cursor-not-allowed bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
                <div className="mb-6">
                    <label className="block mb-2 text-sm font-medium text-gray-900">Ngày đến</label>
                ...
                <div className="mb-6">
                    <label className="mr-2 text-sm font-medium text-gray-900">Số lượng khách:</label>
                    <InputNumber min={1} max={10} value={formik.values.soLuongKhach} onChange={(value) => handleChangeInput(Number(value),'soLuongKhach')}/>
                </div>
                <div className="mb-6">
                    <label className="block mb-2 text-sm font-medium text-gray-900">Mã người đặt</label>
                    <input type="text" disabled={true} name="maNguoiDung" onChange={formik.handleChange} onBlur={formik.handleBlur} value={formik.values.maNguoiDung} className="cursor-not-allowed bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" />
                </div>
